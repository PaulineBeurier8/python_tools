...
dag = DAG(dag_id='test_hello_world', description='Simple tutorial DAG with email operator and params',
          schedule_interval='00 09 * * *',
          default_args = default_args, catchup=False)


hello_op = PythonOperator(task_id='hello_task', python_callable=generate_hello, xcom_push=True, dag=dag)
